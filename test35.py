...
def heartbeat_logger_server(host, port, log_file):
...
port = 15880  # Choose a port number (change if needed)
log_file = 'heartbeat_log2.txt'  # Specify the log file name

# Start the heartbeat logger server
heartbeat_logger_server(host, port, log_file)