    ...
    for read_cmd in read_cmds:
        try:
            ...
            if reading:
                ...
                elif isinstance(reading, Heartbeat):
...
async def send_readings(ccu_no: str,
                        hes_server_url: str,
                        readings: dict,
                        auth_token: str,
                        logger: Logger):
    ...
    res = json.dumps(readings_formatted, indent=None, default=str)
